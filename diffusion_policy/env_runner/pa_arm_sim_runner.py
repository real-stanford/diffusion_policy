...
from diffusion_policy.env.pa_arm.pa_arm_sim_env import PAArmSimEnv
...
class PAArmSimRunner(BaseImageRunner):
    def __init__(
        self,
        output_dir,
        n_train=10,
        ...
        def env_fn():
            return MultiStepWrapper(
                VideoRecordingWrapper(
                    PAArmSimEnv(legacy=legacy_test, render_size=render_size),
